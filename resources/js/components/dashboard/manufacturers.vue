    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <modal ref="editcityPad" title="EDIT MANUFACTURER" no-close-on-backdrop no-close-on-esc hide-cancel  :hide-ok="true" @cancel="$refs.editcityPad.hide()" centered>
                ...
                <modal ref="companyProducts" title="MANUFACTURER BRANDS" width="600px"  :hide-ok="true" :hide-cancel="true" @cancel="$refs.companyProducts.hide()" centered>
                <form>
                    <div class="row">
                      <div class="col-md-12 pr-1">
...
<!-- 
                 <modal ref="selectionChart" title="COMPANY VISITOR CHOICE" width="980px"  :hide-ok="true" :hide-cancel="true" @cancel="$refs.selectionChart.hide()" centered>
               ...
               <modal ref="impressionPad" title="COMPANY IMPRESSION DETAILS" width="980px"  :hide-ok="true" :hide-cancel="true" @cancel="$refs.impressionPad.hide()" centered>
...
export default {
  ...
  closeThemodal:function()
  {
    ...
    { 
         axios
            .get('api/getCompanyProducts?data_name=product_attributes&manufacturer_id='+record.id,
            { headers: {
